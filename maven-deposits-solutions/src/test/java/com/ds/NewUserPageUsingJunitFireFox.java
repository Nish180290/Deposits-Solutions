...
/**
 * @author NISH Class NewUserPageUsingJunitFireFox is use to test "New User
 *         Page"
 * 
 */

@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class NewUserPageUsingJunitFireFox {

	private static final Logger logger = Logger.getLogger(NewUserPageUsingJunitFireFox.class.getName());
	private static WebDriver newUserPageDriver;
	static String username;
	String newUserPageURL = "http://85.93.17.135:9000";

	/**
	 * testSetUp Method to setup webdrivers for firefox
	 */
	@BeforeClass
	public static void testSetUp() {
		logger.info("Method: testSetUp() execution starts");
		System.setProperty("webdriver.firefox.marionette",
				"D:\\Deposits-solutions\\maven-deposits-solutions\\Driver\\geckodriver-v0.19.0-win64\\geckodriver.exe");
		newUserPageDriver = new FirefoxDriver();
	...
	/**
	 * tearDown method is used to quit the FireFox driver
	 */
	@AfterClass
