...
/**
 * @author NISH Class NewUserTestsUsingJunitIE is use to test "New User Page"
 * 
 */

@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class NewUserTestsUsingJunitIE {

	private static final Logger logger = Logger.getLogger(NewUserTestsUsingJunitIE.class.getName());
	private static WebDriver newUserPageDriver;
	static String username;
	String newUserPageURL = "http://85.93.17.135:9000";

	/**
	 * testSetUp Method to setup webdrivers for IE
	 */
	@BeforeClass
	public static void testSetUp() {
		logger.info("Method: testSetUp() execution starts");
		System.setProperty("webdriver.ie.driver","D:\\Deposits-solutions\\maven-deposits-solutions\\Driver\\IEDriverServer_Win32_3.5.1\\IEDriverServer.exe");
		newUserPageDriver = new InternetExplorerDriver();
	...
	/**
	 * tearDown method is used to quit the IE driver
	 */
	@AfterClass
